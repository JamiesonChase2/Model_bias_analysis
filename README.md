...
8. Group summary: compare mean activations by trait, profession, and gender group.
...
11. Feature difference plots: largest control/male/female spread per trait and profession.
12. Gender disparity plots: largest non-zero matched male-female gaps per trait and profession.
13. Group plot: trait-by-profession-by-gender activation summary.
...
The current design tests whether gender context modulates explicit trait framing. It does not test whether bare profession nouns implicitly activate competence or leadership features.
